...
@task
def hotel_list_scraping_narita():
    hotel_results = []
    # Step 1. 크롬 웹브라우저 실행
    ...
    file_name = f'raw_data_hotel/narita/narita_{now}.json'
...
# 나리타를 기준으로 하면 호텔 수가 너무 부족한 관계로 치바 현으로 범위를 넓히고 크롤링
with DAG(
